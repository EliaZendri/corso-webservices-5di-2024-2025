...
```
CRUD --> Create Upadte Delite 
npm i cors
npm i --crypto
CRUD --> Create Update Delite 
...
Fase di deploy = fase conclusiva dell appicalzione / rilascio dell app
docker file --> creo una nuova immagine 
docker compose --> mando in esecuzione i container
YAML --> formato per la serializzazione di dati
